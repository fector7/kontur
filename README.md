...
|---|---|---|---|---|
| 1 | Подбор пароля (Brute-Force) | CWE-307, CWE-521, CWE-204 | Высокая | ✅ Да |
| 2 | Доступ к КТ без аутентификации | CWE-306, CWE-284, CWE-862 | Критическая | ✅ Да |
| 3 | Предсказуемые сессионные токены | CWE-330 | Высокая | ✅ Да |
| 4 | Обход каталога (Path Traversal) → RCE | CWE-22, CWE-434 | Критическая | ✅ Да |
| 5 | Нарушение ролевого доступа (КТ) | CWE-284 | Критическая | ✅ Да |
| 6 | Передача данных по HTTP | CWE-319 | Высокая | — |
| 7 | Пароль не маскируется | CWE-549 | Средняя | — |
| 8 | Нет требований к сложности паролей | CWE-521 | Средняя | — |
| 9 | Нет CSRF-защиты | CWE-352 | Средняя | — |
| 10 | Нет HTTP-заголовков безопасности | — | Низкая | — |
| 11 | Загрузка файлов без ограничений | CWE-434 | Средняя | — |
| 12 | Открытые службы (FTP, устаревший SSH) | — | Средняя | — |
| 13 | Работа с правами root | CWE-250 | Высокая | — |
| 14 | Слабый алгоритм хеширования (MD5) | CWE-327 | Высокая | — |
